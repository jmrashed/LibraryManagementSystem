...
$title =  addslashes($_GET['category']);
                                                $query = "SELECT * FROM books WHERE section='$title' ORDER BY accession_no  DESC";
$result = mysqli_query($mysqli, $query) or trigger_error("Query Failed! SQL: $query - Error: ". mysqli_error($mysqli), E_USER_ERROR);

?>                           <h2 style="text-transform: uppercase"><?php echo $title;    ?>    Books</h2>
